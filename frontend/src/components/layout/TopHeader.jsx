...
import { Compass, ShieldCheck, LayoutDashboard } from 'lucide-react';
...
const TopHeader = () => {
    ...
    return (
        <header className="h-20 border-b border-slate-200 bg-white flex items-center justify-between px-10 sticky top-0 z-50 shadow-[0_1px_3px_0_rgba(0,0,0,0.02)]">
